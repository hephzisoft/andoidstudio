...
//    VERIFY USER
    public boolean verifyUser(String username, String password){
        ...
        if (cursor.getCount() > 0){
            ...
            if(result == -1) Toast.makeText(context, "An error occured while fetching data.", Toast.LENGTH_SHORT).show();
            return true;
...
//    DELETE DISH
    ...
    //    EDIT DISH
    public void editDish(int id, String name, String ingredients, String process, String image_url){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
